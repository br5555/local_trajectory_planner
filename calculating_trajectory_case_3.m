function [t1, t2, t3, t4, t5, t6, t7] = calculating_trajectory_case_3(jerk_max, jerk_min, acc_max, acc_min,vel_max, vel_min, vel_start, vel_end, p_start, p_end, acc_start, acc_end)
...
t5=a_5/jerk_min;
a_6 = a_5;
t7 = (acc_end - acc_min)/jerk_max;
v_6 = vel_end - t7*a_6 - 0.5*(t7^2)*jerk_max;
v_4 = v_3 ;
v_5 = v_4 + t5*a_4 + 0.5*((t5)^2)*jerk_min;
t6 = (v_6 - v_5)/a_5;
